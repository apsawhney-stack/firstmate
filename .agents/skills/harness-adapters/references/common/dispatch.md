...
Apply `../../../task-contract/SKILL.md`'s suitability assessment to every selection path, including typed `clear` and default fallback, as input to existing model fit rather than another resolver.
