...
- `task-contract` - load before finalizing a ship specification or scout question, and before materially revising task scope; it owns semantic risk, specification completeness, opt-in lifecycle binding, and suitability input to existing model-fit selection.
