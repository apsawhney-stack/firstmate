...
| --- | --- |
| Accepted behavior | The user-visible or operator-visible change and its authoritative source |
| Invariants | What must remain true, including relevant scope, identities and quantifiers |
| Examples and counterexamples | An allowed case and a meaningful rejection or boundary for each changed executable claim; derive negative cases independently of the implementation |
...
| Validation | Known safe commands with arguments and working directory, expected results and what they prove, or the exact unresolved prerequisite |
| Unresolved decisions | Explicitly none, or the question, owner and affected behavior |
