...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  <id>/binding       opt-in ship task-contract binding for the brief's Captain's intent and Firstmate spec; written only by bin/fm-task-contract.sh adopt and checked by bin/fm-task-contract.sh/fm-spawn before enrolled launch or relaunch
...
- `task-contract` - load before finalizing a ship specification or scout question, and before materially revising task scope; it owns semantic risk, specification completeness, and suitability input to existing model-fit selection.
